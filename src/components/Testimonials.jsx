...
const fallbackQuotes = [
  ...
  { avatar: '/img/avatar-athlete-3-128x128.jpg', name: 'James R.', role: 'Iron Dassie', text: 'The diet plan alone was worth the upgrade. I was eating well but not eating right for how I train. Within a few weeks my recovery improved and I stopped hitting that afternoon wall. The AI coach recommendations each week keep things fresh too.' },
];
