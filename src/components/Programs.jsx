...
const fallbackTiers = [
  ...
  { level: 'Committed', name: 'Rock Runner', desc: "Self-starters who want structure and accountability. You know you'll show up and be ready to train.", price: '$5', priceSub: '/ month', features: ['Customized workout routines', 'Benchmark tracking', 'Full workout video library', 'Downloadable PDF guides', 'Progress analytics'], cta: 'Get Started', ctaClass: 'btn primary', featured: true },
  { level: 'All In', name: 'Iron Dassie', desc: 'No half measures. Expert guidance, peak nutrition, and a system fully customized around your life.', price: '$20', priceSub: '/ month', features: ['Digital Personal Trainer', 'Customized workout routines', 'Customized diet plans', 'Benchmark tracking', 'Full workout video library', 'Downloadable PDF guides', 'Priority support'], cta: 'Get Started', ctaClass: 'btn primary' },
];
